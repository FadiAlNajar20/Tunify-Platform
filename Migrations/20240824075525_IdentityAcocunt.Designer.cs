...
namespace Tunify_Platform.Migrations
{
    ...
    [Migration("20240824075525_IdentityAcocunt")]
    partial class IdentityAcocunt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tunify_Platform.Album", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AlbumName = "Album 1",
                            ArtistID = 1,
                            ReleaseDate = new DateTime(2024, 8, 24, 10, 55, 25, 196, DateTimeKind.Local).AddTicks(5252)
                        });
                });
            ...
            modelBuilder.Entity("Tunify_Platform.ModelUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 24, 10, 55, 25, 196, DateTimeKind.Local).AddTicks(4699),
                            SubscriptionID = 1,
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            JoinDate = new DateTime(2024, 8, 24, 10, 55, 25, 196, DateTimeKind.Local).AddTicks(4720),
                            SubscriptionID = 1,
                            Username = "user2"
                        });
                });
            ...
            modelBuilder.Entity("Tunify_Platform.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PlaylistID = 1,
                            CreatedDate = new DateTime(2024, 8, 24, 10, 55, 25, 196, DateTimeKind.Local).AddTicks(5265),
                            ModelUserID = 1,
                        ...
                        {
                            PlaylistID = 2,
                            CreatedDate = new DateTime(2024, 8, 24, 10, 55, 25, 196, DateTimeKind.Local).AddTicks(5267),
                            ModelUserID = 2,
